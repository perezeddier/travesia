...
const I18N = {
  en: {
    ...
    "pm.q1": "What if my flight is delayed — even at 2 AM?",
    "pm.a1": "We track your flight in real time and adjust your pickup. Your driver waits for you — same price, any hour, no extra charge.",
    "pm.q2": "What if I can't find my driver when I land?",
    "pm.a2": "Your driver is there before you land, holding a sign with your name. The day before, we send you the driver's name and WhatsApp — plus our company WhatsApp. Two ways to reach us, always.",
    "pm.q3": "I'm traveling solo / with friends — is it safe?",
    "pm.a3": "Your van is 100% private — only your group, never shared with strangers. A professional local driver and WhatsApp support the whole way.",
    "pm.q4": "What if my kids get carsick on the road?",
    "pm.a4": "A/C, smooth driving, and we pull over for fresh air whenever you need. Free child seats on request, plus restroom and snack stops along the way.",
    "pm.q5": "What if my plans change and I need to cancel?",
    "pm.a5": "Free cancellation up to 24 hours before pickup. Within 24 hours the booking is non-refundable. Just message us on WhatsApp and we'll take care of it.",
    "pm.q6": "Will anyone confirm everything before my trip?",
    "pm.a6": "Yes. We reconfirm by WhatsApp the day before — pickup time, exact location and your driver. You're never left wondering.",
    "finder.from": "From",
    "finder.to": "To",
  ...
  es: {
    ...
    "pm.q1": "¿Y si mi vuelo se atrasa — aunque sea a las 2 a. m.?",
    "pm.a1": "Seguimos tu vuelo en tiempo real y ajustamos tu recogida. Tu chofer te espera — mismo precio, a cualquier hora, sin cargo extra.",
    "pm.q2": "¿Y si no encuentro a mi chofer al llegar?",
    "pm.a2": "Tu chofer está ahí antes de que aterrices, con un letrero con tu nombre. El día anterior te enviamos el nombre y WhatsApp del chofer — más el WhatsApp de la empresa. Dos formas de contactarnos, siempre.",
    "pm.q3": "Viajo sola / con amigos — ¿es seguro?",
    "pm.a3": "Tu van es 100% privada — solo tu grupo, nunca compartida con desconocidos. Un chofer local profesional y soporte por WhatsApp todo el camino.",
    "pm.q4": "¿Y si mis hijos se marean en el camino?",
    "pm.a4": "Aire acondicionado, manejo suave, y nos detenemos para tomar aire cuando lo necesites. Sillas para niños gratis a solicitud, más paradas para baño y snacks en el camino.",
    "pm.q5": "¿Y si cambian mis planes y necesito cancelar?",
    "pm.a5": "Cancelación gratis hasta 24 horas antes de la recogida. Con menos de 24 horas no es reembolsable. Solo escríbenos por WhatsApp y nos encargamos.",
    "pm.q6": "¿Alguien confirma todo antes de mi viaje?",
    "pm.a6": "Sí. Reconfirmamos por WhatsApp el día anterior — hora de recogida, ubicación exacta y tu chofer. Nunca te quedas con la duda.",
    "finder.from": "Desde",
    "finder.to": "Hasta",
