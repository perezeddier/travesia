...
const I18N = {
  en: {
    ...
    "hero.sub": "Door-to-door private transfers from SJO and Liberia (LIR) airports to La Fortuna, Monteverde, Tamarindo, Manuel Antonio and beyond. Flat rate per vehicle, bilingual drivers, GPS-monitored fleet.",
  ...
  es: {
    ...
    "hero.sub": "Traslados privados puerta a puerta desde los aeropuertos de San José (SJO) y Liberia (LIR) a La Fortuna, Monteverde, Tamarindo, Manuel Antonio y más. Tarifa plana por vehículo, choferes bilingües, flota con GPS.",
