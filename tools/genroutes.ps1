...
"@
  ...
  # El review/aggregateRating va DENTRO de "provider" (la agencia, tipo
  # TravelAgency = subtipo de LocalBusiness), no en el "Service" de arriba.
  # Google no acepta resenas sobre un tipo "Service" generico como entidad
  # valida a calificar (error real de Search Console, 18-set-2026); sobre
  # LocalBusiness si es un tipo admitido.
  $jsonld='{"@context":"https://schema.org","@type":"Service","serviceType":"Private airport shuttle transfer","name":"'+$o.n+' to '+$d.n+' Private Shuttle","provider":{"@type":"TravelAgency","name":"Travesia Costa Rica","telephone":"+50685028476","url":"'+$base+'/"'+$reviewLd+'},"areaServed":{"@type":"Country","name":"Costa Rica"},"offers":{"@type":"Offer","price":"'+$p.s+'","priceCurrency":"USD","url":"'+$url+'"}}'
